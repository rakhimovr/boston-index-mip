...
t <- t %>% 
  rename('Behavior' = behavior,
         ...
         'Belief that others think people engage in the behavior' = ne,
...
t <- t %>% 
  select(Behavior, Adoption, Intention, `Belief that others are engaging in the behavior`, `Belief that others should engage in the behavior`, `Belief that others think people engage in the behavior`, `Program interest`, `Carbon impact ranking`)

reactable(t,
  columns = list(Adoption = colDef(format = colFormat(digits = 2)),
                 Intention = colDef(format = colFormat(digits = 2)),
                 `Belief that others are engaging in the behavior` = colDef(format = colFormat(digits = 2)),
                 `Belief that others should engage in the behavior` = colDef(format = colFormat(digits = 2)),
                 `Belief that others think people engage in the behavior` = colDef(format = colFormat(digits = 2)),
