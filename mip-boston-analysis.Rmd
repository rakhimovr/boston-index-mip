...
- For each segment, in brackets, we have provided the frequency of that segment in the sample. For example, the national sample contains 525 *Males*. 
