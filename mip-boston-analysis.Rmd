...
##### Pearson correlations between reported intention (I) to engage in the behaviors and interest in a program (PI) that helps adopt these behaviors
...
tt3 = res.cor2 %>% 
  ...
  rename('Predictor' = term,
         ...
         'EV: Beliefs that others have adopted' = ev_ee,
