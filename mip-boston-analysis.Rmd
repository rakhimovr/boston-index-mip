...
* Higher reported adoption of MIP behaviors among Boston residents compared to the general population
  + Reported flying frequency and food waste reduction measures are not reported due to the difference in survey items between two samples
```{r, echo = FALSE, results = 'asis', message = FALSE}
Behavior <- c("Proportion that have at least 1 EV", "Proportion that bought a carbon offset in the last 12 month", "Proportion that get electricity from a green energy provider", "Proportion that have solar panels", "Proportion of people's meals that do not include meat")
`Reported adoption among Boston residents` <- c("15%", "6%", "15%", "11%", "5%")
`Reported adoption in the general population` <- c("11%", "2%", "9%", "4%", "6%")

df <- data.frame(Behavior, `Reported adoption among Boston residents`, `Reported adoption in the general population`)
...
df = reactable(df,
  ...
  columns = list(
    Behavior = colDef(
      minWidth = 350,
      align = "left"),
    `Reported.adoption.in.the.general.population` = colDef(
      name = "Reported adoption in the general population",
      minWidth = 250,
      align = "left"),
    `Reported.adoption.among.Boston.residents` = colDef(
      name = "Reported adoption among Boston residents",
      minWidth = 250,
      align = "left")))
...
- People underestimate how many people think they should take actions
  + There is a large difference between *perceived % of population thinking people should adopt these behaviors* and *actual % of population thinking people should adopt the behaviors*
...
* Being retired is negative correlated with interest in programs and intention to adopt the behaviors
